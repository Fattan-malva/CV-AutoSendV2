const en = {
  ...
  landing: {
    heroTitle: 'Build ATS-Friendly CVs & Auto-Send to Every Job',
    heroSub: 'Build professional CVs with AI, upload brochures, analyze applications, send in 1 click.',
    cta: 'Try Free',
    login: 'Login',
    ...
    featuresDesc: 'Build a pro CV, upload brochures, analyze with AI, send — all in one platform.',
    desireLabel: 'Why different',
    desireTitle: 'Build Your CV & Apply from One Place',
    desireParagraph: 'Not just sending applications. Ceefy also helps you build ATS-friendly CVs with AI assistance. All integrated, all automated.',
    desireCards: [
      { title: 'AI CV Builder', desc: 'Build professional CVs with AI assistance. Just input your experience, AI polishes and writes bullet points for you.' },
  ...
  cvBuilder: {
    title: 'CV Builder',
    desc: 'Create and customize your ATS-friendly CV',
    save: 'Save',
    saving: 'Saving...',
    saved: 'Saved!',
